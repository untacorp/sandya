...
3. **Garis Batas Presisi**: Border netral slate bersih (`#E2E8F0` / `#E5E7EB`).
...
- **10% Warna Aksen**: `#2563EB` *(Vibrant Royal Blue)*, `#EA580C` *(Coral)*, atau `#059669` *(Emerald)*
