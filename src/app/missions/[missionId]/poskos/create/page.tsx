...
export default function CreatePoskoPage() {
  ...
  const { session, missions, addPosko } = usePoskoStore();

  const effectiveMissionId = routeMissionId || session.missionId;
  const currentMission = missions.find((m) => m.id === effectiveMissionId);
  const targetOrgId = currentMission?.orgId || session.orgId;
  ...
  return (
    <div className="space-y-5 max-w-xl mx-auto">
      ...
      <PageHeader title="Buka Posko Lapangan Baru" />
        ...
        <CardContent className="p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input placeholder="Contoh: Posko Lapangan RW 05 Kp. Nagrak"
                value={name}
            ...
            <div>
              ...
              <Input placeholder="Contoh: Lapangan Voli Kp. Nagrak RT 02"
                value={locationName}
            ...
            <div>
              ...
              <Input placeholder="Nama koordinator posko"
            ...
            <div className="flex flex-col-reverse sm:flex-row items-center justify-end gap-2 pt-3 border-t border-border">
              <Link
                href={`/missions/${effectiveMissionId}/poskos`}
