...
export function PoskoShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-[100dvh] md:min-h-screen flex bg-canvas text-text-main print:bg-white print:text-black print:min-h-0 print:block">
      {/* Desktop Sidebar */}
