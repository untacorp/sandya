...
Dokumen ini merupakan evaluasi kritis awal terhadap ide sistem di [`docs/idea.md`](file:///home/auttomus/Documents/Code/PROJECT/sandya/docs/idea.md), berfokus pada kelayakan (*feasibility*), mitigasi *race condition*, penanganan limitasi QR code, serta blueprint arsitektur data terdistribusi.
...
>  **[`docs/spesifikasi-mesh-dan-intercom.md`](file:///home/auttomus/Documents/Code/PROJECT/sandya/docs/spesifikasi-mesh-dan-intercom.md)** dan **[`docs/event-sourcing-dan-hierarki.md`](file:///home/auttomus/Documents/Code/PROJECT/sandya/docs/event-sourcing-dan-hierarki.md)**.
