...
> Sistem Sanidya sepenuhnya berfokus pada **Standar Monokrom Hitam-Putih Universal**:
...
Laboratorium Sanidya telah berhasil mengompilasi dan menguji native binary C JabCode (ISO/IEC 23634:2022) dengan hasil kapasitas sebagai berikut:

| Jumlah Pengungsi | Raw JSON | Bit-Packed | Compressed | 1 Kotak QR B&W | 1 Kotak JabCode (8 Warna) |
| :--- | :--- | :--- | :--- | :--- | :---: |
| **50 Jiwa** | $6.594\text{ B}$ | $1.265\text{ B}$ | **$911\text{ B}$** | ✅ Muat (V24) | ✅ **100% Match** |
| **100 Jiwa** | $13.174\text{ B}$ | $2.435\text{ B}$ | **$1.684\text{ B}$** | ✅ Muat (V34) | ✅ **100% Match** |
| **200 Jiwa** | $26.163\text{ B}$ | $4.748\text{ B}$ | **$3.169\text{ B}$** | ❌ Overflow | ✅ **100% Match** |
| **300 Jiwa** | $39.108\text{ B}$ | $7.096\text{ B}$ | **$4.664\text{ B}$** | ❌ Overflow | ✅ **100% Match** |
| **500 Jiwa** | $61.188\text{ B}$ | $7.707\text{ B}$ | **$6.120\text{ B}$** | ❌ Overflow | ❌ **Overflow (>4.8 KB)** |

---

## 2. Mengapa JabCode Dibatalkan untuk Sanidya?
...
Sanidya secara resmi mengadopsi standar monokrom hitam-putih universal yang dirinci pada:
📄 **[`docs/spesifikasi-transfer-animated-dan-poster.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/spesifikasi-transfer-animated-dan-poster.md)**.
