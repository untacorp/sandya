# Arsitektur Event Sourcing, Hierarki Organisasi, & Universal Data Mule: Sanidya

Dokumen ini merupakan spesifikasi arsitektur lanjutan untuk sistem **Sanidya (Offline-First Disaster Management)**, yang merinci model **Event Sourcing** pada pendataan manusia, hierarki posko, prinsip **Universal Data Mule**, dan mitigasi *clock drift*.
...
graph TD
    ...
    Mission --> PosInduk["🏛️ POSKO INDUK / GUDANG UTAMA<br/>Hub Logistik & Manajemen Pusat"]
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **1. 👑 KOORDINATOR** | ✅ Penuh | ✅ Audit | 👁️ Audit Agregat | ✅ **Otorisasi Utama (Ed25519)** | ✅ Bebas |
| **2. 🩺 MEDIS** | ✅ Catat Kondisi | ✅ **Input Triase & Resep Obat** | ❌ (Hanya ajukan tiket obat) | ❌ Dilarang | ✅ Bebas |
| **3. 📦 LOGISTIK** | 👁️ Lihat Data | ❌ | ✅ **Mutasi & Potong Stok** | ❌ Dilarang | ✅ Bebas |
| **4. 📝 RELAWAN** | ✅ **Fast Intake 30s & Tiket Butuh** | ❌ | ❌ (Hanya konfirmasi penyerahan) | ❌ Dilarang | ✅ **Bebas Scan & Ekspor** |
| **[ 🔍 WARGA / TAMU ]** | 👁️ Cari Kerabat Sendiri | ❌ | ❌ | ❌ | 👁️ Pindai Poster (Read-Only) |
...
sequenceDiagram
    ...
    participant PosInduk as 🏛️ HP Koordinator Posko Induk
...
sequenceDiagram
    ...
    participant PosPusat as 🏛️ Posko Induk (Gudang)
