...
| **Ruang Penyimpanan HP Penuh** | SQLite mencapai kuota batas memori | Tampilkan peringatan oranye *"Penyimpanan Hampir Penuh"*, sarankan ekspor cadangan `.sanidya` ke kartu memori / flashdisk USB OTG. |
