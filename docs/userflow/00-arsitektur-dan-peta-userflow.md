# Peta Induk & Arsitektur User Flow: Sanidya v2

> **Status**: Approved (Harmonisasi 100% Tanpa Celah & Transparan)  
> **Ruang Lingkup**: Seluruh Aktor Kemanusiaan, Hierarki 3-Tingkat (Org $\to$ Misi $\to$ Posko), Pusat Situasi Misi Terbuka, Logistik Single-Writer, Triase Medis START, Fast Intake 30s, dan Temu Keluarga.  
...
Sistem Sanidya membagi persona pengguna ke dalam 4 peran inti operasional (+ 2 peran pimpinan hierarki & 1 mode publik):

```
┌──────────────────────────────────────────────────────────────────────────────────┐
│                               TAKSONOMI PERSONA SANIDYA                          │
├──────────────────────┬───────────────────────────────────────────────────────────┤
...
| **🎖️ Komandan Misi** | Command Center Misi | ❌ Ditolak | **Penuh (Misi Ini)** | **Setup & Audit Posko** | **Audit Makro Misi** |
| **👤 Koordinator Posko** | 1 Posko Tenda Fisik | ❌ Ditolak | 👁️ Situasi Misi & Minta Bantuan | **Penuh (Posko Ini)** | 👁️ **Read-Only via Sync** |
| **🩺 Petugas Medis** | Pos Medis Tenda Ini | ❌ Ditolak | 👁️ Radar Medis Misi | **Tulis Triase & Resep** | 👁️ **Read-Only via Sync** |
| **📦 Petugas Logistik** | Gudang Posko Ini | ❌ Ditolak | 👁️ Radar Stok Misi | **Mutasi Stok Fisik** | 👁️ **Read-Only via Sync** |
| **📝 Relawan Lapangan** | Lapangan Tenda Ini | ❌ Ditolak | 👁️ Direktori Posko Misi | **Intake Warga & Antar** | 👁️ **Read-Only via Sync** |
| **🔍 Warga / Tamu** | Meja Informasi Publik | ❌ Ditolak | ❌ Ditolak | ❌ Ditolak | 👁️ **Cari Kerabat** |
...
```mermaid
flowchart TD
    StartGate([🚪 Buka Aplikasi Sanidya: /]) --> Gateway{"Pilih Pintu Masuk"}
    ...
    GenMasterKey --> OrgConsole["🏛️ Konsol Organisasi: /(organization)"]
    ...
    subgraph Cluster_Mesh_Sync ["Pusat Sinkronisasi & Komunikasi Taktis"]
        ...
        OutboxQueue --> SyncPoster["🖨️ Fallback Kertas (Poster Paritas XOR 3-dari-4)"]
    end
    ...
    DetectNet -->|Ya| AutoReplicate["☁️ Auto-Replication ke Server (Managed / BYOC)"]
...
|:---|:---|:---|
| **00** | [`docs/userflow/00-arsitektur-dan-peta-userflow.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/userflow/00-arsitektur-dan-peta-userflow.md) | Peta Induk, Hierarki 3-Tingkat, RBAC, dan Global Flow. |
| **01** | [`docs/userflow/01-onboarding-dan-manajemen-organisasi.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/userflow/01-onboarding-dan-manajemen-organisasi.md) | Onboarding 3 Pintu, Ed25519 Master Key, Kartu Tugas QR. |
| **02** | [`docs/userflow/02-pendataan-warga-dan-event-sourcing.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/userflow/02-pendataan-warga-dan-event-sourcing.md) | Fast Mobile Intake 30s, Append-Only Timeline, NIK Null-Bypass. |
| **03** | [`docs/userflow/03-triase-medis-dan-rekam-kesehatan.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/userflow/03-triase-medis-dan-rekam-kesehatan.md) | Papan Kanban Triase START (🔴🟡🟢⚫), Resep Obat, Skrining. |
| **04** | [`docs/userflow/04-logistik-dan-distribusi-single-writer.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/userflow/04-logistik-dan-distribusi-single-writer.md) | Buku Kas Mutasi Single-Writer, Tiket Kebutuhan, Surat Jalan. |
| **05** | [`docs/userflow/05-sinkronisasi-p2p-dan-poster-paritas.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/userflow/05-sinkronisasi-p2p-dan-poster-paritas.md) | Zero-Touch BLE Mesh Gossip, Animated Multipart QR, Poster Paritas XOR. |
| **06** | [`docs/userflow/06-temu-keluarga-offline.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/userflow/06-temu-keluarga-offline.md) | Rekonsiliasi Graf Temu Keluarga Otomatis Multi-Posko. |
| **07** | [`docs/userflow/07-komunikasi-taktis-dan-mesh-intercom.md`](file:///home/auttomus/Documents/Code/PROJECT/sanidya_v2/docs/userflow/07-komunikasi-taktis-dan-mesh-intercom.md) | **NEW**: Radio Lapangan 4 Saluran, Push-to-Talk (PTT) Suara Opus 3.2 kbps, SOS Alarm. |
