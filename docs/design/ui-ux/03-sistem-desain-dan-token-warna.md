# Sistem Desain & Token Warna Semantik: Sanidya v2

Dokumen ini mendefinisikan standar token warna terpusat yang diintegrasikan ke dalam **CSS Variables** dan **Tailwind CSS v4 `@theme`** pada aplikasi Sanidya.

---

## 🎨 Katalog Token Warna Semantik

```css
:root {
  /* ==========================================
   * 1. CANVAS & SURFACES (Var-UI Base Crisp Light)
   * ========================================== */
