# Blueprint Arsitektur Frontend: Sandya

> **Standar Rekayasa**: Next.js 16 (App Router, React 19 RSC) + Tauri v2 Desktop & Mobile  
> **Prinsip Desain**: [Sistem Desain & Token Warna Semantik](./03-sistem-desain-dan-token-warna.md)  
...
> **Dokumen Terkait**: [Arsitektur UI & Dashboard](../../arsitektur-ui-dan-dashboard.md) | [Pedoman Solar Icons](./02-pedoman-solar-icons.md)
...
Setiap modul antarmuka wajib mengimplementasikan 6 status:
...
## 4. Standar Desain Visual Sandya

- **Warna Latar**: `#FFFFFF` (*Crisp White*) dan `#F8FAFC` (*Crisp Slate 50*).
- **Struktur Garis**: Border presisi 1.5px `#E2E8F0` (*Slate 200*).
- **Ikon**: Stroke SVG minimalis (Solar Icons), tanpa emoji Unicode pada label tombol atau teks UI.
