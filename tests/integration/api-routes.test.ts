...
async function runIntegrationTests() {
  ...
  console.log('  [PASS] Fast Intake 201 Created Verified');
  ...
  console.log('  [PASS] Refugee Roster Query 200 OK Verified');
  ...
  console.log('  [PASS] Event Sourcing Timeline 200 OK Verified');
  ...
  const testItem = InventoryAggregate.create({
  id: asItemId('posko-demo-001-item-001'),
  poskoId: asPoskoId('posko-demo-001'),
  itemName: 'Beras 5kg',
  category: 'FOOD',
  initialQuantity: 100,
  unit: 'KARUNG',
  ...
  if (testItem.ok) {
  await container.inventoryRepo.save(testItem.value);
  }
  ...
  console.log('  [PASS] Single-Writer Logistics Mutation & Protection Verified');
  ...
  console.log('  [PASS] Ed25519 Cryptographic Ingestion 200 OK Verified');
  ...
  console.log('  [PASS] Disaster Analytics & KPI Telemetry 200 OK Verified');
  ...
  console.log('  [PASS] Tactical Message Broadcast & History 201/200 OK Verified');
